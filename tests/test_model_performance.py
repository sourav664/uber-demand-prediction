...
import dagshub
dagshub.init(repo_owner='sourav664', repo_name='uber-demand-prediction', mlflow=True)


# set the mlflow tracking uri
mlflow.set_tracking_uri("https://dagshub.com/sourav664/uber-demand-prediction.mlflow")
...
@pytest.mark.parametrize(argnames="data_path,threshold",
                         argvalues=[(train_data_path,0.12),
                                    (test_data_path,0.12)])
